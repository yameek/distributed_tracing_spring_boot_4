...
> For onboarding instructions, helper scripts, and Gradle examples, visit the [Developer Guide](Developer-Guide.md). Use this matrix when validating controller compatibility.
...
**Current Behavior:** SDK ignores the `@CookieValue` parameter.

**Impact:** Cookie-based authentication or session management is not supported.
