...
3. Explore [Feature Overview](Home.md) for feature-level details and [Controller Support Matrix](Controller-Features.md) for the controller support matrix.
...
- [Home](Home.md) – High-level overview and configuration options.
- [Controller Support Matrix](Controller-Features.md) – Supported annotations, parameter rules, and limitations.
- [Demo Playground Walkthrough](Home.md#demo-spring-boot-application) – Demo playground walkthrough (controllers, endpoints, and generated code locations).
